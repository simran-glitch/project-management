...
<html>
    <head>
        ...
        <link href="RegisteredHodList.css" rel="stylesheet" type="text/css"/>
    </head>
    <body>
        <br><br><br>
    <center>
        ...
        %>
        <table border="2">
            <header id="trisha1">Here The Registered Hod List</header><br/>
            <tr>
                <th>Hod Name</th><th>User Name</th><th>Password</th><th>Mobile No</th><th>Department</th>
            </tr>
            <%
